  ...
  public: {
    Tables: {
      ...
      pages: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "pages_tree_id_fkey"
            columns: ["tree_id"]
            isOneToOne: false
            referencedRelation: "space_trees"
            referencedColumns: ["id"]
      ...
      space_permissions: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "space_permissions_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
      ...
      space_trees: {
        ...
        Relationships: [
          {
            foreignKeyName: "space_trees_space_id_fkey"
            columns: ["space_id"]
            isOneToOne: false
            referencedRelation: "spaces"
            referencedColumns: ["id"]
    ...
    Functions: {
      has_role: {
        Args: {
          _user_id: string
          _role_name: Database["public"]["Enums"]["role_name"]
        }
        Returns: boolean
      }
      has_space_permission: {
        Args: {
          _user_id: string
          _space_id: string
          _scopes: Database["public"]["Enums"]["permission_scope"][]
        }
        Returns: boolean
      }
      has_write_space_permission: {
        Args: {
          _user_id: string
          _space_id: string
          _scopes: Database["public"]["Enums"]["permission_scope"][]
